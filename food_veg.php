...
<title> kupindetimur | food and vegetable product | kupindedaha timur krishi farm pvt.ltd,Nepal </title>
<meta name="keywords" content="online food order Nepal,whole food juice,whole food stock,online vegetable store,online organic Nepal,metro tarkari online shopping,tarkari price in Nepal,fruit and vegetable in nepal,local vegetable,salyani vegetable,kapur kot tarkari, kupindedaha lake,kupindedaha timur farm ,online shopping,krishi samagri,best organic product ,nepal,salyan ,karnali ,karnali pardesh,buy and sell agriculture product,fresh product,">
<meta name="discription" content="Buy: freshly picked, and dry,powdery form organic and local vegetables and food at low prices in Nepal .Home delivery all over the Nepal and other country.. easy payment method. ">
...
<br><br><br>
 ...
 <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="activ"><a href="food_veg.php"><b class="w3-text-orange">Food & vegetable product</b></a> </li>
                </ul>
            </div>
...
// INSERT INTO `herb`(`id`, `content`, `date`) VALUES ([value-1],[value-2],[value-3])
            ...
            $selectquery = "SELECT * FROM herb  WHERE cat='food&vegetable' ";
...
<div class="row "> 
   <?php 
            ...
            include("./adminstatus/blogadmin/dbc.php");
            $selectquery = "SELECT*FROM  productadd WHERE categories='food&vegetable' ORDER BY id DESC";
            $query = mysqli_query($conn , $selectquery) or die("error");
            $result = mysqli_fetch_assoc($query);
            while ($result= mysqli_fetch_array($query)) {
