...
?>
 ...
 <option value="">-Select State-</option>
  ...
  <label style="font-weight:bold;">Choose Warda :</label><select id="txt" class="form-control" name="warda" required >
    <option value="">-Please select Rural/muncipality first-</option>
  </select>
   <label class="w3-left ml-0 w3-panel"> <b> Local Address:</b></label><input class="form-control p-4"   placeholder="enter office address (optional) *" type="text"  name="localaddress1">
  <!-- <br> <label class="w3-left ml-0 w3-panel"> <b> Local Address:</b></label><input class="form-control p-4"   placeholder="enter office address (optional) *" type="text"  name="localaddress1">
