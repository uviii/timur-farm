...
<title> kupindetimur | Herbal  product | kupindedaha timur krishi farm pvt.ltd,Nepal </title>
<meta name="keywords" content="Herble product online ,buy herbal product,herbal shop near me,herbal company Nepal,natural herbal product,herbal beauty product,online herbalife product,herbal product vedio,organic herbal powder Nepal,natural health and herble product website,aryuvedic product near me,kupindetimur herbal product,health food shop online,amazon herbal product,flipkart herbal product,indiamart herbal product,hamro krishi bazar herbal product,organic herbal product, kupindedaha lake,kupindedaha timur farm ,online shopping,krishi samagri,best organic product ,nepal,salyan ,karnali ,karnali pardesh,buy and sell agriculture product,fresh product,">
<meta name="discription" content="Buy HERBAL products at low prices in Nepal. Shop online for HERBAL products on kupindetimur. Get ....Home delivery all over the Nepal and other country.. easy payment method. ">
 ...
 <div class="block-breadcrumb">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="activ"><a href="medicinal.php"><b class="w3-text-orange">Herble product</b></a> </li>
                </ul>
            </div>
        </div>
...
// INSERT INTO `herb`(`id`, `content`, `date`) VALUES ([value-1],[value-2],[value-3])
            ...
            $selectquery = "SELECT*FROM `herb`  WHERE cat='medicinal_herb' limit 2 ";
...
<div class="row "> 
   <?php 
            ...
            include("./adminstatus/blogadmin/dbc.php");
            $selectquery = "SELECT*FROM  productadd  WHERE categories='medicinal_herb'  ORDER BY id DESC";
            $query = mysqli_query($conn , $selectquery) or die("error");
...
.p a li{padding: 5px;}
  ...
  <div class="col-lg-3 col-md-4 col-sm-12 col-12  w3-gra">
     <div class="rollbar">
      <div class="section">
  <h3 class="section-heading w3-blac" style="border-bottom: 4px solid gray;"> <a href="#"><strong style="background-color: #ffe6e6;" ><b class="w3-text-orange">Porduct list...<span></span>
  </b> </strong> </a><span></span></h3>
