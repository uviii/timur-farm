...
$msg=mysqli_query($conn,"INSERT INTO `user`(`fname`, `lname`, `email`, `contactno`, `country`, `state`, `district` , `city`,`warda`, `localaddress`, `localaddress1`,`zipcode`,`password`, `cpassword`, `tokan`, `status`) VALUES ('$fname','$lname','$email','$contactno','$country','$state','$district','$city','$warda','$local_ad','$localaddress1','$zip','$pass','$cpass','$tokan','active')");
// echo "$msg";
  # code...
    ...
    <div class="col-sm-4 bg-dange container"></div>
     <div class="col-sm-4 bg-succes w3-container">
      <div class="bg-primary container w3-round-large w3-panel p-2 mt-0 mr-0 ml-0"> 
        <h5 class="form-login-heading  w3-center w3-text-white " style="font-weight: bold; font-size: 25px;">Welcome <a href="https://kupindetimur.com/adminstatus/blogadmin/login.php" style="color: white; font-weight: bold; font-size: 25px;">Login</a>  & Registration System</h5></div>
...
<i class="fa fa-plus"></i> create account
              ...
              <div> 
                <br>
              <!-- Button to Open the Modal  -->
<a href=" https://kupindetimur.com/ "><button type="button" class="w3-black w3-hover-red w3-text-white form-control" data-toggle="modal" data-target="">
