...
<br>
<br><div> <h2 class="w3-center container"><b style="font-size: 25px; color: green;">Available Product Quantity Control Panel</b></h2></div>
...
<tbody class="  w3-center ">
		<?php 
            ...
            include("dbc.php");
            $selectquery = "SELECT*FROM `product_qty` order by id desc  ";
...
?>
		...
		<td class="r"><?php echo $result['unit']; ?> </td>
		...
		<td class="r"><?php echo $result['avail']; ?> </td>
		    ...
		    <td> <a href="product_qty_show.php?pid=<?php echo $result['pid']; ?>"><i class="fa fa-eye fa-2x" style="color: orange;"></i></a></td>
		    	...
		    	<!-- <td> <button type="button" class="btn w3-text-red " data-toggle="modal" data-target="#qtyshow" style="border:none; background: transparent;">
  <b> <span class="w3-text-blue">help</span></b>
</button></td> -->
		</tr>
