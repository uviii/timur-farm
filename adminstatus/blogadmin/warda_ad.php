...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-lg-4 col-md-12 col-12"><form class="container" action="warda_add.php" method="POST"  enctype="multipart/form-data">
...
<label class="w3-left"><b>Warda:</b></label><input class="form-control" placeholder="warda No. <?php echo $munci ?>" type="text" name="warda"><br>
