...
$sql="UPDATE `warda_munci` SET `state`='$state', `country`='$country',`munci`='$munci',`warda`='$warda',`district`='$district',`charge_nepal`='$charge_nepal',`charge_other`='$charge_other',`currency`='$currency',`courier`='$courier',`service`='$service',`contact`='$contact' WHERE id=$id   ";
