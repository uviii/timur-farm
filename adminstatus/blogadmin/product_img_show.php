...
<br>
<br><div> <h2 class="w3-center container"><b> product size control panel</b></h2></div>
<hr>
<br>
...
<tr class="bg-success  r ">
		...
		<th class="r">image naem</th>
		<th class="r">introduction</th>
		<th class="r">file</th>
		<th class="r">file type<details> 1=image file,2=vedio file,0=youtube vedio file--</details></th>
...
<tbody class="  w3-center ">
		<?php 
            ...
            include("dbc.php");
             $id=$_GET['pid'];
            $selectquery = "SELECT*FROM `product_img`  WHERE pid='$id'   ";
...
?>
		...
		<td> <a href="product_img_edit.php?pid=<?php echo $result['id']; ?>"><i class="fa fa-edit"></i></a></td>
		<td> <a href="product_img_delet.php?id=<?php echo $result['id']; ?> " data-toggle="tooltip" data-placement="bottom" title="delete" onClick="return confirm('Are you sure you want to delete?');" ><i class="fa fa-trash" aria-hidden="true"></i> </a></td>
		<td> <a href="product_img_show.php?pid=<?php echo $result['pid']; ?>"><i class="fa fa-eye"></i></a></td>
