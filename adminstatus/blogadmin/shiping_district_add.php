...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-4"><form class="container" action="muncipality_add.php" method="POST"  enctype="multipart/form-data">
 

<div>
  <label class="w3-left"><b>district name :</b></label><input  class="form-control" value="<?php echo $district ?>" type="text" name="district"><br>
  
<label class="w3-left"><b>shiping chage :</b></label><input  class="form-control" type="text" name="charge_nepal"><br>
<label class="w3-left"><b>muncipality/rural:</b></label><input class="form-control" value="<?php echo $munci ?>" type="text" name="munci"><br>
<label class="w3-left"><b>Warda:</b></label><input class="form-control" placeholder="enter warda for <?php echo $munci ?>" type="text" name="warda"><br>
