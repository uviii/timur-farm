...
// INSERT INTO `shiping_charge`(`id`, `munci`, `district`, `charge_nepal`, `currency`, `courier`, `service`, `contact`, `charge_other`, `date`) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9],[value-10])
 $sql="INSERT INTO `warda_munci`( `country`, `state`, `district`, `munci`, `warda`, `charge_nepal`, `currency`, `courier`, `service`, `contact`, `charge_other`)  VALUES ('$country','$state','$district','$munci','$warda','$charge_nepal','$currency','$courier','$service','$contact','$charge_other')";
