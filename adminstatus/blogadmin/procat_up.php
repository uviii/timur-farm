...
<div class="w3-center"><h2><b class="w3-center">product catagories update panel</b></h2></div>
<hr>
<br>
...
// UPDATE `productcat` SET `id`=[value-1],`name`=[value-2],`date`=[value-3] WHERE 1

$sql=" UPDATE `productcat` SET `name`='$name' WHERE id='$id'  ";
...
<hr>
 ...
 <?php 
   $catid=$_GET['id'];
            ...
            $selectquery = "SELECT*FROM `productcat`  WHERE id =$catid";
