...
$id=$_GET['id'];
            ...
            $selectqueryy = "SELECT*FROM  `muncipality` WHERE id =$id";
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-lg-4 col-md-12 col-12"><form class="container" action="shiping_district_ediit.php" method="POST"  enctype="multipart/form-data">
...
<label class="w3-left"><b>info:</b></label><input class="form-control" placeholder="warda No. <?php echo $munci ?>" value=" <?php echo $warda ?>"  type="text" name="warda"><br>
   <!-- <div class="w3-panel form-control"><button class="w3-right form-control  w3-blue w3-hover-green"><input class="form-control w3-blue w3-hover-green" type="submit" name="submit" value="upload"></button></div>  -->  
